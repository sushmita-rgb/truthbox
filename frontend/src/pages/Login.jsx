        ...
        <div className="bg-[var(--glass-bg)] backdrop-blur-2xl p-8 md:p-12 rounded-[40px] border border-[var(--border-color)] shadow-2xl w-full max-w-md animate-fade-in-up">
          ...
          <div className="mt-8 space-y-6">
            <div className="relative flex items-center justify-center">
              ...
              <span className="relative bg-[var(--bg-primary)] px-4 text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary)] z-10 rounded-full border border-[var(--border-color)] transition-colors">Or continue with</span>
            </div>
